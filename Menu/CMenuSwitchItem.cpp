...
CMenuSwitchItem::CMenuSwitchItem(char * caption, CMenu * pLinkedMenu):CMenuItem(caption)
{
...
void CMenuSwitchItem::enter()
{
	CMenu::setActiveMenu(m_pLinkedMenu);
}
/*
float CMenuSwitchItem::getWidth()
{
	return CApplication::m_pTextDrawer->getLength(m_cCaption);
}
*/
void CMenuSwitchItem::draw()
{
	if (m_bActive)
	{	
		drawQuad();
